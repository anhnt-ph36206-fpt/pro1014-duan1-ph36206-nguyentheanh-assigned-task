    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          ...
          <a href="index.php?act=adddm" class="btn btn-success float-right">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="index.php?act=suadm&id=<?= $danhMuc['id'] ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i> Sửa
                      </a>
                      <a href="index.php?act=xoadm&id=<?= $danhMuc['id'] ?>" 
